      ...
      <div className="flex flex-1 overflow-hidden">
        <div className="flex-1 overflow-y-auto p-6">
          <div className="w-[90%] mx-auto">
            ...
            {/* Layout chính */}
            <div
              className={`relative flex w-full h-full transition-[gap] duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] overflow-hidden ${
            ...
            >
              ...
              >
                <div
                  className={`grid gap-4 py-4 px-1 transition-all duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] ${
                    selectedPokemon
              ...
              <div
                ...
                transition-transform duration-700 ease-[cubic-bezier(0.16,1,0.3,1)] sm:block
